...
public class ExcelMonitor { 
 ...
 String filePath = "C:\\Gowri\\Full stack development\\18.Dev apps cont CICD-Cont monitiring\\ScienceFair.xlsx"; // Path to the Excel file 
        ...
        for (int i = 1; i <= sheet.getLastRowNum(); i++) { 
            ...
            if (isCellEmpty(nameCell) || isCellEmpty(projectCell)) { 
                System.out.println("Row " + (i + 1) + ":"
                		+ "// Missing student name or project title."); 
                errorsFound = true; 
            } 
